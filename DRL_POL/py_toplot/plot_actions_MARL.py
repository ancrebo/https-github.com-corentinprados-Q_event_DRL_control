...
for i_jet in range(1,10):  # Change the second component in range() to set how many jet do you want to see
    string_epi = 'ep_{}'.format(num_episode)
    data0 = np.genfromtxt("../actions/environment1/1_{}/{}/output_actions.csv".format(i_jet, string_epi), delimiter=";", names=names)
